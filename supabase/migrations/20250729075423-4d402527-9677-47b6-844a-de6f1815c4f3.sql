-- Comprehensive Database Cleanup and Reset
...
-- Phase 3: Clear Admin and Authentication Data
...
-- Phase 7: Reset any sequences if needed
-- Most tables use uuid default values, so no sequence reset needed

-- Verification queries (these will return 0 if cleanup was successful)
DO $$
DECLARE
    table_count INTEGER;
