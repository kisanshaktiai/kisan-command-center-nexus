...
-- Fix ENUM casting and improve create_tenant_with_validation function
...
-- Add super admin bypass policies for key tables
-- Tenants table
...
DROP POLICY IF EXISTS "super_admin_bypass_branding" ON tenant_branding;
CREATE POLICY "super_admin_bypass_branding"
ON tenant_branding
FOR ALL
TO authenticated
USING (
...
DROP POLICY IF EXISTS "super_admin_bypass_features" ON tenant_features;
CREATE POLICY "super_admin_bypass_features"
ON tenant_features
FOR ALL
TO authenticated
USING (
