...
-- Fix the convert_lead_to_tenant_secure function to handle subscription_plan enum correctly
...
DECLARE
    ...
    v_subscription_plan_enum subscription_plan;
BEGIN
    -- Validate inputs
    ...
    BEGIN
        v_subscription_plan_enum := p_subscription_plan::subscription_plan;
    EXCEPTION
        WHEN invalid_text_representation THEN
            -- Default to Kisan_Basic if invalid enum value
            v_subscription_plan_enum := 'Kisan_Basic'::subscription_plan;
    END;
    ...
    ELSE
        ...
        -- Create tenant with proper enum casting
        INSERT INTO public.tenants (
            ...
            'agri_company',
            'trial',
            v_subscription_plan_enum, -- Use properly cast enum value
            ...
            jsonb_build_object(
                ...
                'limits', jsonb_build_object(
                    'max_farmers', CASE v_subscription_plan_enum
                        WHEN 'Kisan_Basic' THEN 1000
                        WHEN 'Shakti_Growth' THEN 5000
                        ELSE 20000
                    END,
                    'max_dealers', CASE v_subscription_plan_enum
